...
helpers.toSatoshi = function(cmm) {
  if (_.isArray(cmm)) {
    return _.map(cmm, helpers.toSatoshi);
  } else {
    return parseFloat((cmm * 1e8).toPrecision(12));
  }
};
...
describe('client API', function() {
  ...
  describe('Build & sign txs', function() {
    ...
    describe('#signTxp', function() {
      ...
      it('should sign cmm proposal correctly', function() {
        var toAddress = 'msj42CCGruhRsFrGATiUuh25dtxYtnpbTx';
        var changeAddress = 'msj42CCGruhRsFrGATiUuh25dtxYtnpbTx';
  ...
  describe('Network fees', function() {
    it('should get current fee levels for BTCZ', function(done) {
      ...
      clients[0].credentials = {};
      clients[0].getFeeLevels('cmm', 'livenet', function(err, levels) {
        should.not.exist(err);
        should.exist(levels);
  ...
  var addrMap = {
    cmm: ['1PuKMvRFfwbLXyEPXZzkGi111gMUCs6uE3','1GG3JQikGC7wxstyavUBDoCJ66bWLLENZC'],
    bch: ['CfNCvxmKYzZsS78pDKKfrDd2doZt3w4jUs','CXivsT4p9F6Us1oQGfo6oJpKiDovJjRVUE']
  };
  _.each(['bch', 'cmm'], function(coin) {
